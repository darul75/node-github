...
if (!module.parent) {
  var argv = Optimist
  .wrap(80)
  .usage("Generate the implementation of the node-linked module, including "
   + "unit-test scaffolds.\nUsage: $0 [-r] [-v VERSION]")
  .alias("r", "restore")
  .describe("r", "Restore .bak files, generated by a previous run, to the original")
  .alias("v", "version")
  .describe("v", "Semantic version number of the API to generate. Example: '1.0'")
  .alias("t", "tests")
